  ...
  return (
    <html lang="en" className="h-full bg-zinc-950">
      <body className="min-h-full text-zinc-100 antialiased">
        ...
        <a
          href="#main"
          className="sr-only focus:not-sr-only focus:fixed focus:top-3 focus:left-3 focus:z-50 focus:rounded-md focus:bg-zinc-800 focus:px-3 focus:py-2"
        >
          Skip to content
        </a>
        ...
        <footer className="border-t border-zinc-800/60">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-6 text-sm text-zinc-400">
